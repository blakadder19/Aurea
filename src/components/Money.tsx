...
export function Money({ value, tone = 'ink', signed = false, className = '', serif = false, decimals = 2 }: MoneyProps) {
  const text = signed ? formatMoneySigned(value, decimals) : formatMoney(value, decimals)
  return (
