...
export const demoMonthlyReport: MonthlyReport = {
  ...
  categories: [
    { name: 'Hogar y facturas', categoryId: null, spentCents: 65000, pctOfTotal: (65000 / 276000) * 100, children: [] },
    { name: 'Restaurantes', categoryId: null, spentCents: 52000, pctOfTotal: (52000 / 276000) * 100, children: [] },
    { name: 'Supermercado', categoryId: null, spentCents: 48000, pctOfTotal: (48000 / 276000) * 100, children: [] },
    { name: 'Otros', categoryId: null, spentCents: 34000, pctOfTotal: (34000 / 276000) * 100, children: [] },
    { name: 'Ocio y suscripciones', categoryId: null, spentCents: 26000, pctOfTotal: (26000 / 276000) * 100, children: [] },
    { name: 'Transporte', categoryId: null, spentCents: 18000, pctOfTotal: (18000 / 276000) * 100, children: [] },
    { name: 'Ropa y cuidado', categoryId: null, spentCents: 17000, pctOfTotal: (17000 / 276000) * 100, children: [] },
    { name: 'Salud', categoryId: null, spentCents: 16000, pctOfTotal: (16000 / 276000) * 100, children: [] },
  ],
